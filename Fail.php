...
$sql = "SELECT * FROM appointments WHERE status = 'fail'";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td style="text-transform: uppercase;">abnormal</td>';
    ...
    echo "<tr><td colspan='3'>No appointments for student that are abnormal status found</td></tr>";
}
