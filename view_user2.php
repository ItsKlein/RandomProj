...
<body>
    <div class="center-content">
        <!-- Style the "Back" button as a white box with indigo-colored letters -->
        <a href="http://localhost/Zppsu_Medical/Student_Status/Doctor_Student_Status.php" class="custom-button" title="Back to Home">Back to Home</a>
                                ...
                                <div class="col-lg-4">
                                    <div class="card shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <br>
                                            <button class="appointmentModalButton" onclick="openModal()">MESSAGE</button>
...
<div id="appointmentModal" class="modal">
    <div class="modal-content">
        ...
        <h2>SEND A APPOINTMENT DATE</h2>
        
        
        <form action="#" method="post" id="appointmentForm">
            <!-- Hidden input field to store the recipient email -->
            <input type="hidden" id="recipientEmail"  value="<?php echo $user_appointments['email']; ?>">
            <textarea id="appointmentMessage" placeholder="Type your appointment message..." name="appointmentMessage" required></textarea>
            <br>
            <br>
            <button type="submit" id="sendButton" name="submit">Send</button>
        </form>
    </div>
</div>
...
if (isset($_POST['submit'])) {
    if (!empty($_POST['appointmentMessage'])) {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            // Get the recipient's email and message from the form
            $recipientEmail = $user_appointments['email'];
            $appointmentMessage = $_POST['appointmentMessage'];
            ...
            try {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'leeshanez123@gmail.com';
                $mail->Password = 'kpbjajkbjvjcyood';
                $mail->SMTPSecure = 'tls';
                $mail->Port = 587;

                $mail->setFrom('leeshanez123@gmail.com');
                ...
                // Email content
                $mail->isHTML(true);
                $mail->Subject = 'Appointment Message';
                $mail->Body = $appointmentMessage;
