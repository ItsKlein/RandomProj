...
window.location.href = viewUrl;{
    ...
    <h2>College of Arts Humanities and Social Science</h2>
    <table class="custom-table">
        ...
        include ('C:\xampp\htdocs\Zppsu_Medical\Php_Logics\connection.php');
                ...
                $courseNames = ["BS Development Communication", "BS Fine Arts in Industrial Design", "BA Sining ng Filipino"];

// Create a comma-separated list of course names for the SQL query
